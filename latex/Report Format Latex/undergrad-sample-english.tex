...
Excluding a basic testing strategy, in order to see an actual response of the application’s performance and if it accomplished users need. We have give a chance to some representative a hands on testing of our application. By letting them test how to use the program with some advices from us as developers. And giving them a user survey of our application using Google Form, to collect responses if they like the features or not. According to the responses, all of responses are from current students of KMUTT CPE. And the results of the survey data are shown below.
